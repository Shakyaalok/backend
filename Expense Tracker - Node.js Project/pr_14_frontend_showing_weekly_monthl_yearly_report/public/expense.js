...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (decodeToken.ispremiumuser) {
        ...
        <div>
        <button class="btn btn-info" id='showRport'>show Report</button.
        </div>
    ...
    const showRport = document.getElementById('showRport');
    showRport.addEventListener('click', showReport)

    function showReport() {
        window.location.href = '/showReportForm.html'
    }
})
